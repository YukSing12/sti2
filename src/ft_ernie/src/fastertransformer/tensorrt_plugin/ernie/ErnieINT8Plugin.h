...
namespace {
static const char* ENCODER_NAME{"ErnieINT8Plugin"};
...
class ErnieINT8Plugin: public IPluginV2DynamicExt {
private:
    ...
    ErnieINT8EncoderWeight<half>*           pErnieEncoderWeightInt_    = nullptr;
    // ErnieINT8EncoderWeight<float>*          pErnieEncoderWeightFloat_   = nullptr;
    Allocator<AllocatorType::CUDA>*     pAllocator_                 = nullptr;
    cublasMMWrapper*                    pCublasWrapper_             = nullptr;
    ErnieINT8Encoder<half>*                 pErnieEncoderInt_          = nullptr;
    // ErnieINT8Encoder<float>*                pErnieEncoderFloat_         = nullptr;
    struct {
...
public:
    ErnieINT8Plugin() = delete;
    ErnieINT8Plugin(const std::string& name,
                    ...
                    bool               own_weight);
    ErnieINT8Plugin(const std::string& name, const void* buffer, size_t length);
    ~ErnieINT8Plugin();
...
class ErnieINT8PluginCreator: public IPluginCreator {
private:
