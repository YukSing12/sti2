...
# rm gemm_config*.in
if [ "$1" == "ft_infer" ];then
    ./bin/ft_infer 1 ./model/bin ./data/label.test.txt ./label.res.txt --useCudaGraph --computeInFp16
    ./bin/ft_infer 1 ./model/bin ./data/perf.test.txt ./perf.res.txt --useCudaGraph --computeInFp16
else 
