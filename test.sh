...
if [ "$1" == "ernie_infer" ];then
    ./bin/ernie_infer 1 ./model/bin ./data/label.test.txt ./label.res.txt --useCudaGraph  --int8
    ./bin/ernie_infer 1 ./model/bin ./data/perf.test.txt ./perf.res.txt --useCudaGraph --int8
else
