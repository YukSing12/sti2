...
# Options for dynamic trt:  --ln  --aln --eln --ffnrelu --dymshape --postemb
cd $ROOT_DIR
modify_cmd="python src/python/modify_ERNIE.py --src model/model.onnx --dst model/modified_model.onnx --ln  --aln --eln --ffnrelu --dymshape --postemb"
